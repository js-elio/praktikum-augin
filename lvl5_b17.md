...
// Die Dauer der Pilzpower
game.powerDuration = 3;
// Die Zeit an der die Plizpower vorbei ist
game.powerEndTime = 0;

// Pilze sind sammelbare Gegenstände mit Standardeffekten
...
function checkTimers() {
    // Wenn die Spielzeit größer ist als die Spiel powerEndTime
